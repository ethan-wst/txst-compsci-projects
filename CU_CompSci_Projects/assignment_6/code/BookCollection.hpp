...
class BookCollection {
    ...
    public:
        ...
        void _destruct(Book* &book);
        void _addBook(Book* &book, string bookName, string author, double rating);
        void _showBookCollection(Book* book);
        void _showBook(Book* book, string bookName);
        void _showBooksByAuthor(Book* book, string author);
        void _showHighestRatedBooks(Book* book);
        double _findHighestRatedBooks(Book* book);
        int _getHeightOfBookCollection(Book* book);
};
