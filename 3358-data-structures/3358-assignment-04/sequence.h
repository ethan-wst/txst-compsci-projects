// FILE: sequence.h
// TEMPLATE PROVIDED: sequence<item>
//
// TEMPLATE PARAMETER, TYPEDEFS and MEMBER CONSTANTS for the sequence<Item> class:
//   The template parrameter, Item, is the data type of the items in the sequence,
//   also defined as sequence<Item>::value_type. 
...
//   sequence()
//     Pre:  (none)
//     Post: The sequence has been initialized as an empty sequence of the
//           set data type.
//
